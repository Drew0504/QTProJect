CLASS_3_GROUPS_SELECTOR = [f"第{str(i)}组" for i in range(1, 9)]

CLASS_3_STUDENTS = [str(i) for i in range(6, 10)]
CLASS_4_GROUPS_SELECTOR = [
    "The Light Land",
    "CEO",
    "Yao Jie",
    "Under One",
...
CLASS_4_STUDENTS = ['郑茹', '张宇生', '许宏伟', '姜岩', '姜寓琪', '陈艺', '罗志泽', '王悦', '李兆宣', '胡梦玲', '姚新宇', '朱芮莹', '祁向冉', '陈子涛', '陈俊如',
                    '宁静', '赵紫怡', '张嘉宸', '丁杨', '司灏', '冯培玉', '杨岳', '纪云鹏', '刘晋言', '郭美岐', '赵云静', '王婕', '董硕', '陈晓波', '张洪宁',
                    '李丹阳', '朱海波', '商博', '宋玥', '陈宝洁', '张胜瑀', '任怡娇', '迟佳怡', '于清冰', '张靖婕', '高远', '林美君', '邢一凡', '王家仪']
